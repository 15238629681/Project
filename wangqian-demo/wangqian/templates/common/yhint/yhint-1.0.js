...
var Yhint = function(opt) {
    ...
    if(opt.resTime !== undefined && typeof opt.resTime !== 'number') {
        throw 'yhint: type of resTime is number'
    }

    this.successBgColor = opt.successBgColor || '#b3e4d1'
    this.successFontColor = opt.successFontColor || '#40B2F1'
...
Yhint.prototype.styleSheet = function(type) {
...
Yhint.prototype.closeFailed = function() {
...
Yhint.prototype.failed = function(words) {
    var self = this
